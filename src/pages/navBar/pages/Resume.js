        ...
        return (
            <div className='resume-page'>
                <div className='resume-main'>
                        <h1 className="cv-title">My Curriculum Vitae</h1>
                        <div className="cv-body">
                            
                            <ul className="cv-list">
                                <article class="episode" id="first_story">
                                    <div class="episode__number">00</div>
                                    <div class="episode__content">
                                    <div class="title">1st Experience </div>
                                    <div class="story" >
                                        <h2>NTT Data</h2>
                                ...
                                <article class="episode" id="second_story">
                                    <div class="episode__number">01</div>
                                    <div class="episode__content">
                                    <div class="title">2nd Experience</div>
                                    <div class="story" >
                                        <h2>Altice</h2>
                                ...
                                <article class="episode" id="third_story">
                                    <div class="episode__number">02</div>
                                    <div class="episode__content">
                                    <div class="title">3rd Experience</div>
                                    <div class="story">
                                        <h2>Nokia</h2>
                                ...
                                <article class="episode" id="third_story">
                                    ...
                                    <div class="episode__content">
                                    <div class="title">4th Experience</div>
                                    <div class="story">
